...
const achievements = [
  { icon: Code2, title: "All Projects", description: "Built using React Native,Flutter, Firebase, Node.js" },
  { icon: Zap, title: "Eager Learner", description: "Always exploring and applying new technologies" },
  { icon: Target, title: "Strong Foundations", description: "React Native, Fluter, iOS/Android, UI/UX" },
  { icon: Heart, title: "Passionate", description: "Creating simple & Intuitive mobile experiences." }
];
          ...
          <div>
            ...
            <motion.div variants={itemVariants}>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Hi, I’m a Mobile App Expert with a focus on building cross-platform mobile applications using React Native and Flutter.
                I specialize in creating fast, reliable, and visually elegant mobile products that deliver a native-quality experience on both iOS and Android.
                With a strong background in frontend architecture and mobile performance optimization, I help startups and established businesses turn their ideas into scalable, production-ready apps.
              </p>
            </motion.div>
