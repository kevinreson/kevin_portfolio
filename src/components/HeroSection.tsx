      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
            Passionate about building modern mobile applications that are fast, intuitive, and cross-platform.
            Always eager to learn and create real-world solutions using Flutter, React Native, and mobile technologies.
          </p>
        </motion.div>
